...
function MoralisDappProvider({ children }) {
  ...
  return (
    <MoralisDappContext.Provider value={{ walletAddress, chainId, marketAddress, setMarketAddress, contractABI, setContractABI, user }}>
      {children}
